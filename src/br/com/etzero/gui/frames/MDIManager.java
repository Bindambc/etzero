...
public class MDIManager {
	 ...
	 *            para não permitir.
	 */
	public MDIManager(JDesktopPane dPane, int maxX, int maxY, int minX, int minY, int distanceXY, boolean reply) {
		this.dPane = dPane;
		this.maxX = maxX;
		this.maxY = maxY;
		this.minX = minX;
	 ...
	 *            permitir.
	 */
	public MDIManager(JDesktopPane dPane, int distanceXY, boolean reply) {
		this.dPane = dPane;
		this.distanceXY = distanceXY;
		this.reply = reply;
